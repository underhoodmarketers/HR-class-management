...
export default async function AdminProfilePage({
  ...
  return (
    <div className="space-y-6">
      ...
      <Link href="/admin/location-finances" className="card flex items-center justify-between p-6 hover:bg-blush/20">
        <div>
          <h2 className="font-600">Revenue &amp; expenses</h2>
          <p className="text-sm text-ink/50">Studio-by-studio revenue and costs, by month.</p>
        </div>
